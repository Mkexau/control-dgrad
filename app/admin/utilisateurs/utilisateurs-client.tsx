  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-3.5 bg-amber-50/70 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/80 rounded-xl text-xs text-amber-900 dark:text-amber-300 flex items-start gap-2.5">
        ...
        <span>
          <strong>Règle de séparation des pouvoirs :</strong> L&apos;attribution du rôle ADMIN est strictement technique. Il ne confère aucun droit d&apos;approbation de mission DG ou Chef de Section.
        </span>
      </div>
